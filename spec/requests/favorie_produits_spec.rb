...
RSpec.describe "/favorie_produits", type: :request do
  # This should return the minimal set of attributes required to create a valid
  # FavorieProduit. As you add validations to FavorieProduit, be sure to
  ...
  # FavorieProduitsController, or in your router and rack
